...
import ChangePasswordFromDashborad from '../../DashboardModule/components/ChangePasswordDashborad/ChangePasswordFromDashborad'
  ...
  <>
    <Routes location={location} key={location.pathname}>
          ...
          <MasterLayout />
              ...
              <Route path="changePassword" element={<ChangePasswordFromDashborad />} />
            </Route>
          </Routes>
  </>
