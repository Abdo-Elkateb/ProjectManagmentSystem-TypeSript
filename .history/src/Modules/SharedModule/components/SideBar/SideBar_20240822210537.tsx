...
export default function SideBar() {
  ...
  const handleCollapse = () => {
    ...
    setIconRotation(prevRotation => prevRotation === 1 ? -100% : 1);
  }
      ...
      <div className='sidebar-container sticky-top'>
        ...
        >
          <Menu className='my-5 py-5'>
            ...
            >
              <div className="icon-container bg-warnin p-2 rounded-3" style={isCollapse ? { transform: `transform(${iconRotation})` } :
