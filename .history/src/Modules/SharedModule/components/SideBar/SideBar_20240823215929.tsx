      ...
      <div className='sidebar-container sticky-top'>
        ...
        >
          <Menu className='my-5 py-5'>
            ...
            >
              <div className="icon-container  p-2 rounded-3" style={isCollapse ? { transform: `scaleX(${iconRotation})` } :
                { transform: `scaleX(${iconRotation})`, background: "hsla(35, 86%, 55%, 1)" }}>
            ...
            <MenuItem
              className='mt-4 mb-2'
              component={<NavLink style={navLinkStyles} to="" end />}
            ...
            {loginUser?.userGroup == 'Manager' ? <MenuItem
              className="mb-2"
              component={<NavLink style={navLinkStyles} to="users" />}
            ...
            <MenuItem
              className="mb-2"
              component={<NavLink style={navLinkStyles} to="projects" />}
            ...
            <MenuItem
              className="mb-2"
              component={<NavLink style={navLinkStyles} to="tasks" />}
        ...
        <Modal className='pt-4' show={show} onHide={handleClose}>
          ...
          <Modal.Body  form-container p-5 bg-main rounded-2 dark-tabel`}>
